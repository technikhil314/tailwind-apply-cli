...
export const LocalVideo = ({ isVlog }) => {
  ...
  return isStarted ? (
    ...
    >
      ...
      ></video>
      <video
        className="bottom-0 right-0 w-full rounded absolute"
        width={200}
        height={100}
        muted
        controls
      ...
      ></video>
      <video
        className="absolute bottom-0 right-0 w-full rounded z-1"
        width={200}
        height={100}
        muted
        controls
      ...
      ></video>
      <video
        className="absolute bottom-0 right-0 w-full rounded z-10"
        width={200}
        height={100}
        muted
        controls
